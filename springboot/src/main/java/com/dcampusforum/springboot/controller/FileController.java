...
//        System.getProperty("user.dir") 找到campusforum的路径
        String rootFilePath = System.getProperty("user.dir") + "/springboot/src/main/resources/files/" + flag + "_" + originalFilename; //上传路径
    ...
    public JSON editorUpload(MultipartFile file) throws IOException {
        ...
        FileUtil.writeBytes(file.getBytes(), rootFilePath);  // 把文件写入到上传的路径 开源工具类hutool
