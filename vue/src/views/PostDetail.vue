      ...
      <el-row>
        <el-col :span="6">
          ...
          <div style="background-color: #f6ffff;text-align: center;height:100%;padding: 20px;">
            <el-avatar
                :src=this.postsVO.avatar
                :size=100
            />
            <p style="margin: 40px 0;">{{this.postsVO.author}}</p>
            <p v-html="postsVO.email" style="font-size: 12px;margin-bottom: 20px;" ></p>
            <p v-html="postsVO.postsPubdate" style="font-size: 12px;"></p>
          </div>
        ...
        <el-col :span="18">
          <div style="padding: 20px;">
            <h1 v-html="postsVO.postsTitle"></h1><br/>
            <p v-html="this.postsVO.postsDetail"></p>
          </div>
...
export default {
  ...
  methods: {
    ...
    getPosts(){
      request.get("/posts/getVO/"+this.postsId).then(res=> {
        this.postsVO = res.data
        console.log(res.data);

      })
    },
    getDiscuss() {
      request.get("/discuss/getVO/"+"p," + this.postsId).then(res=> {
    ...
    goBack(){
      ...
      window.location.href = "/postFront";
    },
    ...
    save() {
      ...
      this.form.belong = "p," + this.postsId
